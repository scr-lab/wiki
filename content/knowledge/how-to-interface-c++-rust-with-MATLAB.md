...
1. [MATLABとは](#matlab-overview)
2. [インストール](#installation)
3. [ライセンス認証](#license)
4. [ディレクトリ構成と基本設定](#directory-setup)
5. [ターミナルからの実行](#terminal-exec)
6. [C++ との連携（MEX / Engine API）](#cpp-integration)
7. [Rust との連携（FFI 経由）](#rust-integration)
